...
```
`type` is either "mic" or "file". if you choose file, then a `file_path` pointing to a .wav file must be specified. If you choose "mic", this will be ignored.
